...
## Let us explore the relationship between the average sale price for overall house quality
```{r quali-sale}
...
```{r road type}
## Let's plot the association between overall house quality and road type
